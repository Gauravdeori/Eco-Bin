    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader
            title="Auto-dispatch"
            subtitle="Collection runs itself unless you turn this off"
          />
          <div className="space-y-3 px-5 pb-5">
            <p className="rounded-xl bg-slate-50 px-3 py-2 text-[11px] leading-relaxed text-slate-600 dark:bg-slate-800/60 dark:text-slate-300">
              A bin that needs emptying is given a truck, the route is planned, and the truck
              is marked idle again when it gets back. Every dispatch is announced in the alert
              feed, and the dispatch buttons keep working by hand alongside it.
            </p>
